...
class CanvasModel with ChangeNotifier {
  ...
  */
  ...
  updateScale_old3(double v, Offset focalPoint) {
    ...
    debugPrint("RUSTDESK_DEBUG: model: updateScale: scalefactor=$v | oldscale=$s | newscale=$_scale | canvasleftxy=$_x x $_y | mouseposxy=${focalPoint.dx} x ${focalPoint.dy} | localY=$localY | minscale=$mins");
